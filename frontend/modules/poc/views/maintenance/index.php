...
/* @var $searchModel common\models\search\MaintenanceSearch */
...
<div class="maintenance-index">
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Gen value', 'id' => 'grid-maintenance-search-type_id']
            ],
        'date',
        'supplier_id',
        'remark',
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Gen value', 'id' => 'grid-maintenance-search-status_id']
            ],
        [
    ...
    <?= DynaGrid::widget([
        ...
        'gridOptions'=>[
            ...
            'toolbar' => [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['class' => 'btn btn-success', 'title'=>'Create Maintenance']) . ' '.
