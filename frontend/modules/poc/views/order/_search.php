...
<div class="col-md-4">
    ...
    <?php /* echo $form->field($model, 'seller_id')->widget(\kartik\widgets\Select2::classname(), [
    ...
    <?php /* echo $form->field($model, 'buyyer_id')->widget(\kartik\widgets\Select2::classname(), [
        'data' => \yii\helpers\ArrayHelper::map(\common\models\Company::find()->orderBy('id')->asArray()->all(), 'id', 'name'),
        'options' => ['placeholder' => 'Choose Company'],
        'pluginOptions' => [
            'allowClear' => true
