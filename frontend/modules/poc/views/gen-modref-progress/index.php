...
/* @var $searchModel common\models\search\GenModrefProgressSearch */
...
$this->title = 'Gen Modref Progress';
...
?>
<div class="gen-modref-progress-index">
    ...
    <?= DynaGrid::widget([
        ...
        'gridOptions'=>[
            ...
            'toolbar' => [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['class' => 'btn btn-success', 'title'=>'Create Gen Modref Progress']) . ' '.
