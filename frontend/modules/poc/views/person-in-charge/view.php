...
<div class="person-in-charge-view">
    ...
    <div class="box">
        <div class="box-header">
            <h2 class="box-title"><?= 'Person In Charge'.' '. Html::encode($this->title) ?></h2>
        ...
        <div class="box-body">
            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#PersonInCharge" data-toggle="tab"><?= 'Person In Charge' ?></a></li>
                    <?php if ($model->status) : ?>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="PersonInCharge">
                        <?php 
                        $gridColumn = [
