...
/* @var $searchModel common\models\search\WarrantySearch */
...
<div class="warranty-index">
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Gen value', 'id' => 'grid-warranty-search-type_id']
            ],
        'start_date',
        'end_date',
        'remark',
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Gen value', 'id' => 'grid-warranty-search-status_id']
            ],
        [
    ...
    <?= DynaGrid::widget([
        ...
        'gridOptions'=>[
            ...
            'toolbar' => [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['class' => 'btn btn-success', 'title'=>'Create Warranty']) . ' '.
