...
use Yii;
use common\models\GenValue;
use common\models\search\GenValueSearch;
...
/**
 * GenValueController implements the CRUD actions for GenValue model.
 */
class GenValueController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'add-asset', 'add-category', 'add-company', 'add-diposal', 'add-diposal-item', 'add-inventory', 'add-inventory-item', 'add-jt-subcategory', 'add-location', 'add-maintenance', 'add-movement', 'add-order', 'add-order-item', 'add-person-in-charge', 'add-profile', 'add-setting', 'add-subcategory', 'add-transaction', 'add-user', 'add-warranty'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    */
    ...
    /**
     * Lists all GenValue models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new GenValueSearch();
    ...
    /**
     * Displays a single GenValue model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing GenValue model.
    ...
    /**
     * Deletes an existing GenValue model.
    ...
    /**
     * Permanently deletes an existing GenValue model.
     * If deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Finds the GenValue model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return GenValue the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = GenValue::findOne($id)) !== null) {
            return $model;
        } else {
