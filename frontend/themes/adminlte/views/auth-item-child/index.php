...
/* @var $searchModel common\models\search\AuthItemChildSearch */
...
<div class="auth-item-child-index">
    ...
    <?= DynaGrid::widget([
        ...
        'gridOptions'=>[
            ...
            'toolbar' => [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['class' => 'btn btn-success', 'title'=>'Create Auth Item Child']) . ' '.
