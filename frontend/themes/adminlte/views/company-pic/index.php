...
/* @var $searchModel common\models\search\CompanyPicSearch */
...
<div class="company-pic-index">
    ...
    <?= DynaGrid::widget([
        ...
        'gridOptions'=>[
            ...
            'toolbar' => [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['class' => 'btn btn-success', 'title'=>'Create Company Pic']) . ' '.
