...
<div class="transaction-index">
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Gen value', 'id' => 'grid-transaction-search-type']
            ],
        'date',
        'remark',
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Gen value', 'id' => 'grid-transaction-search-status_id']
            ],
        [
    ...
    <?= DynaGrid::widget([
        ...
        'gridOptions'=>[
            ...
            'toolbar' => [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['class' => 'btn btn-success', 'title'=>'Create Transaction']) . ' '.
