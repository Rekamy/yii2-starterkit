...
<div class="inventory-index">
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Category', 'id' => 'grid-inventory-search-category_id']
            ],
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Subcategory', 'id' => 'grid-inventory-search-subcategory_id']
            ],
        'description',
        'remark',
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Gen value', 'id' => 'grid-inventory-search-status_id']
            ],
        [
    ...
    <?= DynaGrid::widget([
        ...
        'gridOptions'=>[
            ...
            'toolbar' => [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['class' => 'btn btn-success', 'title'=>'Create Inventory']) . ' '.
