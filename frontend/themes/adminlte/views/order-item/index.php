...
<div class="order-item-index">
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Gen value', 'id' => 'grid-order-item-search-type_id']
            ],
        [
                'attribute' => 'order_id',
                'label' => 'Order',
                ...
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\common\models\Order::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Profile', 'id' => 'grid-order-item-search-approved_by']
            ],
        'remark',
        [
                'attribute' => 'status_id',
                ...
                'filterInputOptions' => ['placeholder' => 'Gen value', 'id' => 'grid-order-item-search-status_id']
            ],
        [
    ...
    <?= DynaGrid::widget([
        ...
        'gridOptions'=>[
            ...
            'toolbar' => [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['class' => 'btn btn-success', 'title'=>'Create Order Item']) . ' '.
