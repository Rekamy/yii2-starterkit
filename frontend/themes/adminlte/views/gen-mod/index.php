...
/* @var $searchModel common\models\search\GenModSearch */
...
<div class="gen-mod-index">
    ...
    <?= DynaGrid::widget([
        ...
        'gridOptions'=>[
            ...
            'toolbar' => [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['class' => 'btn btn-success', 'title'=>'Create Gen Mod']) . ' '.
