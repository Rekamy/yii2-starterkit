...
<div class="order-index">
    ...
    <?= DynaGrid::widget([
        ...
        'gridOptions'=>[
            ...
            'toolbar' => [
                ['content'=>
                Html::a('<i class="glyphicon glyphicon-plus"></i> Asset', ['create-asset-order'], ['class' => 'btn btn-success', 'title'=>'Create Order For Asset']) . ' '.
                Html::a('<i class="glyphicon glyphicon-plus"></i> Inventory', ['create-inventory-order'], ['class' => 'btn btn-success', 'title'=>'Create Order For Inventory']) . ' '.
