...
<div class="gen-modref-progress-view">
    ...
    <div class="box">
        <div class="box-header">
            <h2 class="box-title"><?= 'Gen Modref Progress'.' '. Html::encode($this->title) ?></h2>
        ...
        <div class="box-body">
            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#GenModrefProgress" data-toggle="tab"><?= 'Gen Modref Progress' ?></a></li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="GenModrefProgress">
                        <?php 
                        $gridColumn = [
