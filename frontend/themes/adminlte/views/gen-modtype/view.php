...
?>
<div class="gen-modtype-view">

    <div class="box">
        <div class="box-header">
            <h2 class="box-title"><?= 'Gen Modtype'.' '. Html::encode($this->title) ?></h2>
        ...
        <div class="box-body">
            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#GenModtype" data-toggle="tab"><?= 'Gen Modtype' ?></a></li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="GenModtype">
                        <?php 
                        $gridColumn = [
