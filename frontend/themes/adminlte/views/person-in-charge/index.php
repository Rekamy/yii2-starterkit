...
/* @var $searchModel common\models\search\PersonInChargeSearch */
...
?>
<div class="person-in-charge-index">
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Location', 'id' => 'grid-person-in-charge-search-location_id']
            ],
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Profile', 'id' => 'grid-person-in-charge-search-profile_id']
            ],
        'remark',
        [
                'attribute' => 'status_id',
                ...
                'filterInputOptions' => ['placeholder' => 'Gen value', 'id' => 'grid-person-in-charge-search-status_id']
            ],
        [
    ...
    <?= DynaGrid::widget([
        ...
        'gridOptions'=>[
            ...
            'toolbar' => [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['class' => 'btn btn-success', 'title'=>'Create Person In Charge']) . ' '.
