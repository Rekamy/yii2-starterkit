...
?>
<div class="company-pic-view">

    <div class="box">
        <div class="box-header">
            <h2 class="box-title"><?= 'Company Pic'.' '. Html::encode($this->title) ?></h2>
        ...
        <div class="box-body">
            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#CompanyPic" data-toggle="tab"><?= 'Company Pic' ?></a></li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="CompanyPic">
                        <?php 
                        $gridColumn = [
