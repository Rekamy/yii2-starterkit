...
/**
 * This is the base model class for table "gen_modref_progress".
 *
 * @property integer $id
 ...
 */
class GenModrefProgress extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\GenModrefProgressQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \common\models\query\GenModrefProgressQuery(get_called_class());
        ...
        return $query->andWhere(['gen_modref_progress.deleted_by' => 0]);
    }
}
