...
class Category extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasMany(\common\models\Asset::className(), ['category_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\common\models\Inventory::className(), ['category_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\common\models\JtSubcategory::className(), ['category_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\common\models\Subcategory::className(), ['id' => 'subcategory_id'])->viaTable('jt_subcategory', ['category_id' => 'id']);
    }
    ...
    public static function find()
    {
        $query = new \common\models\query\CategoryQuery(get_called_class());
        ...
        return $query->andWhere(['category.deleted_by' => 0]);
    }
}
