...
/**
 * This is the base model class for table "gen_modref".
 *
 * @property integer $id
 * @property string $code
 * @property integer $gen_mod_id
 * @property integer $gen_modtype_id
 ...
 */
class GenModref extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\GenModrefQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \common\models\query\GenModrefQuery(get_called_class());
        ...
        return $query->andWhere(['gen_modref.deleted_by' => 0]);
    }
}
