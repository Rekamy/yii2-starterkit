...
class Movement extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\MovementQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \common\models\query\MovementQuery(get_called_class());
        ...
        return $query->andWhere(['movement.deleted_by' => 0]);
    }
}
