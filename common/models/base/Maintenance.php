...
/**
 * This is the base model class for table "maintenance".
 *
 * @property integer $id
...
class Maintenance extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\MaintenanceQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \common\models\query\MaintenanceQuery(get_called_class());
        ...
        return $query->andWhere(['maintenance.deleted_by' => 0]);
    }
}
