...
/**
 * This is the base model class for table "gen_mod".
 *
 * @property integer $id
 ...
 */
class GenMod extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\GenModQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \common\models\query\GenModQuery(get_called_class());
        ...
        return $query->andWhere(['gen_mod.deleted_by' => 0]);
    }
}
