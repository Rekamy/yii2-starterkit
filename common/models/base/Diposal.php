...
/**
 * This is the base model class for table "diposal".
 *
 * @property integer $id
 ...
 * @property \common\models\Profile $disposedBy
 ...
 */
class Diposal extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return [
            [['transaction_id', 'type_id', 'order_by', 'attend_by', 'approved_by', 'disposed_by', 'status_id', 'created_by', 'updated_by', 'deleted_by'], 'integer'],
            [['order_no'], 'required'],
            [['order_date', 'attend_date', 'approved_at', 'disposed_at', 'created_at', 'updated_at', 'deleted_at'], 'safe'],
    ...
    {
        return $this->hasOne(\common\models\Profile::className(), ['id' => 'disposed_by']);
    }
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\DiposalQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \common\models\query\DiposalQuery(get_called_class());
        ...
        return $query->andWhere(['diposal.deleted_by' => 0]);
    }
}
