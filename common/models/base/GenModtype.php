...
/**
 * This is the base model class for table "gen_modtype".
 *
 * @property integer $id
 ...
 */
class GenModtype extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\GenModtypeQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \common\models\query\GenModtypeQuery(get_called_class());
        ...
        return $query->andWhere(['gen_modtype.deleted_by' => 0]);
    }
}
