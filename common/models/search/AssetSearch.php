...
/**
 * common\models\search\AssetSearch represents the model behind the search form about `common\models\Asset`.
 */
 class AssetSearch extends Asset
{
    ...
    {
        return [
            [['id', 'category_id', 'subcategory_id', 'supplier_id', 'manufacturer_id', 'disposal_item_id', 'status_id', 'created_by', 'updated_by', 'deleted_by'], 'integer'],
            [['asset_no', 'description', 'supplier_code_no', 'manufacturer_code_no', 'remark', 'created_at', 'updated_at', 'deleted_at'], 'safe'],
        ];
    }
