...
/**
 * common\models\search\MovementSearch represents the model behind the search form about `common\models\Movement`.
 */
 class MovementSearch extends Movement
{
    ...
    {
        return [
            [['id', 'item_id', 'type_id', 'from', 'to', 'status_id', 'created_by', 'updated_by', 'deleted_by'], 'integer'],
