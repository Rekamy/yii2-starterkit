...
/**
 * common\models\search\GenModtypeSearch represents the model behind the search form about `common\models\GenModtype`.
 */
 class GenModtypeSearch extends GenModtype
{
